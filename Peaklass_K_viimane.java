...
public class Peaklass {
    ...
    public static void main(String[] args) {
        ...
        Kontsert kontsert3 = new Kontsert("Torm", "Rakvere teater", "06-04-2020", 25, 14);
        Kontsert[] kontserdid = {kontsert1, kontsert2, kontsert3};
        ...
        System.out.println("Hetkel on valikus sellised kontserdid: " + kontsert1.getKontserdiPealkiri() + ", toimub " + kontsert1.getToimumiseAeg() +"; "+
                kontsert2.getKontserdiPealkiri() + ", toimub " + kontsert2.getToimumiseAeg() +  "; " + kontsert3.getKontserdiPealkiri() + ", toimub " + kontsert3.getToimumiseAeg() + ".");
